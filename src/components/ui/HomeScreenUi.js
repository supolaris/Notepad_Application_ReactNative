            ...
            <View style={styles.titleCatagoriesView}>
                ...
                <View style={styles.catagoriesView}>
                    <View style={styles.catagoryOneView}>
                        ...
                        <View>
                            <Text style={{textAlign: 'center', fontSize: 18, color: 'black', fontWeight: 'bold'}}>{props.homeCount}</Text>
                        </View>
                    ...
                    <View>
                            <Text style={{textAlign: 'center', fontSize: 18, color: 'black', fontWeight: 'bold'}}>{props.officeCount}</Text>
                        </View>

                        <Pressable
                            onPress={props.onOfficeCatagoryPressed}>
                            <View style={styles.imageView}>
                                <Image
                                    style={styles.image}
                ...
                <View style={styles.catagoriesView}>
                    <View style={styles.catagoryThreeView}>
                        ...
                        <Pressable
                            onPress={props.onWorkCatagoryPressed}>
                            <View style={styles.catgoriesTitleView}>
                                <Text style={[styles.catagoriesTitleText, { borderTopRightRadius: 20 }]}>{props.workCatagoryName}</Text>
                            </View>
                            <View style={styles.imageView}>
                                <Image
                                    style={styles.image}
                        ...
                        <View>
                            <Text style={{textAlign: 'center', fontSize: 18, color: 'black', fontWeight: 'bold'}}>{props.workCount}</Text>
                        </View>
                    ...
                    <View style={styles.catagoryFourView}>
                        ...
                        <Pressable
                            onPress={props.onHealthCatagoryPressed}>
                            <View style={styles.catgoriesTitleView}>

                                <Text style={[styles.catagoriesTitleText, { borderTopLeftRadius: 20 }]}>{props.healthCatagoryName}</Text>
                            </View>
                            <View style={styles.imageView}>
                                <Image
                                    style={[styles.image]}
                        ...
                        <View>
                            <Text style={{textAlign: 'center', fontSize: 18, color: 'black', fontWeight: 'bold'}}>{props.healthCount}</Text>
                        </View>
